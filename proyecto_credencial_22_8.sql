...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-08-2024 a las 18:12:51
...
(70, 47017712, 'ciro lazarte', 'cirolazarte713@gmail.com', 'islas malvinas 4191', '4', '8', '22', '../uploads/dni frente.jpeg', '../uploads/dni atras.png', '../uploads/WhatsApp Image 2024-02-27 at 01.06.55.jpeg', '../uploads/WhatsApp Image 2024-02-27 at 01.09.00.jpeg', 'habilitado'),
(71, 28767647, 'amancay lopez', 'amancaylopez21@gmail.com', '54', '7', '8', '22', '../uploads/dni frente.jpeg', '../uploads/dni atras.png', '../uploads/foto.jpg', '../uploads/Captura de pantalla 2024-06-13 130433.png', 'habilitado');
...
INSERT INTO `horarios` (`id`, `id_cooperativa`, `horario`, `url`) VALUES
(1, 2, 'semana', '../uploads/horarios/horario_semana_cooperativa_2.pdf'),
(2, 2, 'fin-de-semana', ''),
(4, 3, 'semana', ''),
(5, 3, 'fin-de-semana', ''),
(6, 1, 'semana', ''),
...
(12345758, '47017712', '$2y$10$kfxYJXlwW05jQYlPi3Mn2OVVjQwlIaC.sfHyEIcPwCkLgDxumvuRO'),
(12345759, '28767647', '$2y$10$Mdpw87O9mUR9IQleCEhfJuGWWoAF0/GWcyp5xonKN5UzJiKhO3uiK');
...
--
ALTER TABLE `usuarios`
  MODIFY `id_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12345760;
...
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `horarios_ibfk_1` FOREIGN KEY (`id_cooperativa`) REFERENCES `cooperativa` (`id_cooperativa`);
COMMIT;
